...
$options = "/NDL" # /R:2 
$logfile = "C:\Users\paulj\OneDrive\Documents\scripts\WindowsPowerShell\logs\synclog.txt"
...
Robocopy.exe "$source_onedrive_book" "$dest_googledrive_book" $files /LOG+:$logfile #$copy_control # $options # 